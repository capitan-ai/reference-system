...
async function getPrismaColumns() {
  ...
  return {
    ...
    'ref_links': ['id', 'customer_id', 'ref_code', 'url', 'issued_at', 'status', 'created_at'],
    ...
    'ref_matches': ['id', 'booking_id', 'customer_id', 'ref_code', 'ref_click_id', 'matched_via', 'confidence', 'matched_at', 'created_at'],
    'ref_rewards': ['id', 'type', 'referrer_customer_id', 'friend_customer_id', 'booking_id', 'ref_match_id', 'amount', 'currency', 'status', 'reason', 'created_at', 'granted_at', 'redeemed_at'],
    ...
    'processed_events': ['idempotency_key', 'created_at'],
