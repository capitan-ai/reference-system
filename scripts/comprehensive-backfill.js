  ...
  try {
    ...
    for (const b of allSquareBookings) {
      try {
        ...
        // Prepare data object for create (includes creator_type, creator_customer_id)
        const bookingData = {
        ...
        // Update object excludes creator_type, creator_customer_id, administrator_id (preserve original from first insert)
        const { creator_type, creator_customer_id, ...updateData } = bookingData;
