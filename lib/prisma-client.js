...
function ensureConnectionOptions(urlString, includePoolHints = false) {
  ...
  try {
    ...
    console.warn('⚠️ Unable to normalize DATABASE_URL for Neon:', error.message)
    return urlString
  }
}

const normalizedDatabaseUrl = ensureConnectionOptions(DATABASE_URL, isNeonConnection)
