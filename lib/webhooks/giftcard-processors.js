...
const environment = squareEnvironmentName === 'sandbox' ? SquareEnvironment.Sandbox : SquareEnvironment.Production
...
const giftCardsApi = squareClient.giftCards
const giftCardActivitiesApi = squareClient.giftCards
const customerCustomAttributesApi = squareClient.customers.customAttributes
const bookingCustomAttributesApi = squareClient.bookings.customAttributes
  ...
  try {
    ...
    if (customer.used_referral_code) {
      ...
      if (referrer) {
        ...
        // STRICT VALIDATION: Prevent self-referral
