  ...
  const computeSQL = `
    ...
    created_by_admin AS (
      SELECT
        ...
        DATE(b.created_at AT TIME ZONE 'America/Los_Angeles') as created_day_pacific,
        DATE(b.start_at AT TIME ZONE 'America/Los_Angeles') as visit_day_pacific,
        DATE_TRUNC('month', (b.created_at AT TIME ZONE 'America/Los_Angeles')::timestamptz)::date as created_month_pacific,
        DATE_TRUNC('month', (b.start_at AT TIME ZONE 'America/Los_Angeles')::timestamptz)::date as visit_month_pacific
      FROM bookings b
